...
theme.font                                      = "Noto Sans Regular 14"
...
theme.weather = lain.widget.weather({
    city_id = 1270351, -- India (haridwar)
    notification_preset = { font = "Noto Sans Mono Medium 12", fg = theme.fg_normal },
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)), "#343434"),
            ...
            arrow("#CB755B", "#88CC00"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), "#88cc00"),
            arrow("#88CC00", "#777E76"),
